...
export async function POST(req: Request) {
  ...
  // Launch Codex in the background. We deliberately use `codex exec --full-auto`
  // (no review prompts, can hit the filesystem) inside the goal's dedicated cwd
  // so artifacts land in a known location for the Workspace preview.
