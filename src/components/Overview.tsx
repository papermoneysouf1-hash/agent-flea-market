...
export default function Overview() {
  ...
  useEffect(() => {
    ...
    fetchIt();
    const t = setInterval(fetchIt, 6000);
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
          <AgentPortal
            href="/claude"
            title="Claude"
            tagline="Street sage with full tool use. Command line, MCPs, plugins."
          ...
          <AgentPortal
            href="/openclaw"
            title="OpenClaw"
            tagline="Local gateway stall. Chat one-shot or launch the control room."
          ...
          <AgentPortal
            href="/hermes"
            title="Hermes"
            tagline="Nous Research stall. Tool calls, kanban, skills, plugins."
